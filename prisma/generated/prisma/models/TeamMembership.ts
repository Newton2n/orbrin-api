...
export type TeamMembershipOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"teamId" | "userId" | "createdAt" | "updatedAt", ExtArgs["result"]["teamMembership"]>
...
export interface TeamMembershipDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const teamMembershipWithTeamIdOnly = await prisma.teamMembership.findMany({ select: { teamId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TeamMemberships and only return the `teamId`
   * const teamMembershipWithTeamIdOnly = await prisma.teamMembership.createManyAndReturn({
   *   select: { teamId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more TeamMemberships and only return the `teamId`
   * const teamMembershipWithTeamIdOnly = await prisma.teamMembership.updateManyAndReturn({
   *   select: { teamId: true },
   *   where: {
   *     // ... provide filter here
   *   },
