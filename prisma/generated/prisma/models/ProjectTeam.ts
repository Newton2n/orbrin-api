...
export type ProjectTeamWhereInput = {
  ...
  assignedAt?: Prisma.DateTimeFilter<"ProjectTeam"> | Date | string
...
export type ProjectTeamScalarWhereWithAggregatesInput = {
  ...
  assignedAt?: Prisma.DateTimeWithAggregatesFilter<"ProjectTeam"> | Date | string
}
...
export type ProjectTeamOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"projectId" | "teamId" | "assignedAt", ExtArgs["result"]["projectTeam"]>
...
export interface ProjectTeamDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const projectTeamWithProjectIdOnly = await prisma.projectTeam.findMany({ select: { projectId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProjectTeams and only return the `projectId`
   * const projectTeamWithProjectIdOnly = await prisma.projectTeam.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ProjectTeams and only return the `projectId`
   * const projectTeamWithProjectIdOnly = await prisma.projectTeam.updateManyAndReturn({
   *   select: { projectId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProjectTeamFieldRefs {
  ...
  readonly assignedAt: Prisma.FieldRef<"ProjectTeam", 'DateTime'>
}
